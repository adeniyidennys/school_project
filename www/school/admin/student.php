...
if(array_key_exists('submit',$_POST)){
   $error = array();	
	...
	if(empty($error)){
		...
		$stmt = $conn->prepare("INSERT INTO student VALUES(NULL,:nm,:em,:dp,:cc,:num,NOW(),NOW())");
...
while($row = $select->fetch(PDO::FETCH_BOTH)){
	...
	echo"<td> <a href='edit_student.php?id=".$row['student_id']."'> Edit</a></td>";
	echo"<td> <a href='delete_student.php?id=".$row['student_id']."'> Delete</a></td>";
