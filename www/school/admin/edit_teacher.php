...
if(empty($error)){
	...
	$statement = $conn ->prepare("UPDATE teacher SET title = :tt,name=:nm,email=:em,department=:dp,course=:cc,phone_number=:num WHERE teacher_id=:tid");
...
<p>Title: <input type="text" name="title" value="<?= $record['title']?>"/></p>
